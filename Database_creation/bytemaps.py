...
class Dataset:
    ...
    def _get_variables(self):
        data = OrderedDict()        
        try: stream = readgz(self.root, self.filename)
        except: return data
...
def readgz(root, filename):
    '''Using this iteration you could have problem with files with same name but
    located in different folders, it will only read the first file found'''
